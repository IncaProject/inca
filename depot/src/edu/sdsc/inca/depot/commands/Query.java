...
public class Query extends HibernateMessageHandler {
    ...
    try (Connection dbConn = ConnectionManager.getConnectionSource().getConnection()) {
      ...
      while (seriesList.hasNext()) {
        ...
        for (SeriesConfig sc : scSorted ) {
          ...
          Map<Long, String> comparisons = getRelatedComparisons(dbConn, sc.getId());
   ...
   */
  private Map<Long, String> getRelatedComparisons(Connection dbConn, long configId) throws SQLException, PersistenceException {
