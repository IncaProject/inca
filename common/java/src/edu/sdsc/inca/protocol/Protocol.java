...
public class Protocol {
  ...
  /**
   * Command: PERMIT SP dn [ LF dn ... ] SP action CRLF
   * Response: OK CRLF.
   * Indicate that a client passing using a certificate with one of the
   * specified DNs should have permission to perform a specified action.
   * Once granted, permission will be exclusive to the list of DNs. The
   * DN list may be surrounded by quotes to allow for embedded spaces.
   */
  public static final String PERMIT_COMMAND = "PERMIT";
  public static final String NOTIFY_PERMIT_COMMAND = "NOTIFYPERMIT";

  /**
   * Command: REVOKE SP dn SP action CRLF
   * Response: OK CRLF.
   * Indicates that permission for the specified client to perform the
   * specified action will be revoked. The DN may be surrounded by quotes
   * to allow for embedded spaces.
   */
  public static final String REVOKE_COMMAND = "REVOKE";

  /**
   * Command: REVOKEALL SP action CRLF
   * Response: OK CRLF.
   * Indicates that permission for the specified action will be revoked
   * for all clients who are currently permitted to perform the action.
   */
  public static final String REVOKE_ALL_COMMAND = "REVOKEALL";
  ...
  public static final String SUSPEND_MACRO = "__incaSuspend__";
  public static final String
  ...
  public static final String[] COMPUTE_METHODS = {
    "globus2", "globus4", "local", "manual", "ssh"
  };
  public static final String COMPUTE_METHOD_MACRO_DEFAULT = "ssh";
  public static final String GRAM_SERVER_PORT_MACRO_DEFAULT = "2119";
  ...
  public static final String WSGRAM_SERVER_PORT_MACRO_DEFAULT = "8443";
  public static final String WSGRAM_SERVICE_MACRO_DEFAULT = "Fork";
  ...
  public static final String[] SUSPEND_CONDITIONS =
    new String[] {"", "load1", "load5", "load15"};
  ...
  /**
   * Command: [REPORT|RESEND] SP resource LF context LF hostname CRLF
   *          [STDERR SP text CRLF]
   *          STDOUT SP xml CRLF
   *          SYSUSAGE SP usage CRLF
   * Response: OK SP uri.
   * A multi-part command that instructs the depot to insert a new report into
   * the database.  The resource, context, and hostname designate the series,
   * and the two texts are saved in the database without interpretation.  See
   * the Report schema for the xml format.  usage is a newline-separated set of
  ...
  /**
   * Command: QUERYINSTANCE SP nickname LF resource LF target LF collected CRLF
   * Response: QUERYRESULT SP xml CRLF
   *           QUERYEND CRLF.
   * Requests a database lookup of a specified series config nickname, series
   * resource, target hostname, and instance collection time in milliseconds
   * since the Epoch. See the ReportDetails schema for the xml format.
   */
  public static final String QUERY_INSTANCE_COMMAND = "QUERYINSTANCE";

  /**
   * Command: QUERYINSTANCEID SP instance SP config CRLF
   * Response: QUERYRESULT SP xml CRLF
   *           QUERYEND CRLF.
   ...
   * the xml format.
   */
  public static final String QUERY_INSTANCE_BY_ID_COMMAND = "QUERYINSTANCEID";
   ...
   */
   ...
   /**
    * Command: QUERYDEPOTPEERS CRLF
    * Response: OK [ SP uri ] [ LF uri ... ] CRLF
    *
    */
   public static final String QUERY_DEPOT_PEERS_COMMAND = "QUERYDEPOTPEERS";

   /**
    * Command: QUERYREPORTERS CRLF
    * Response: OK xml CRLF
    */
   public static final String QUERY_REPORTERS_COMMAND = "QUERYREPORTERS";

   /**
    * Command: QUERYREPORTERSDETAIL CRLF
    * Response: OK xml CRLF
    */
   public static final String QUERY_REPORTERS_DETAIL_COMMAND = "QUERYREPORTERSDETAIL";
  ...
  /**
   * Command: PEER SP uri CRLF
   * Response: OK xml CRLF
   *
   */
  public static final String REGISTER_PEER_COMMAND = "PEER";
  ...
  /**
   * Command: SYNCDUMP SP uri CRLF
   * Response: OK SP xml CRLF
   *
   */
  public static final String SYNC_DUMP_COMMAND = "SYNCDUMP";

  /**
   * Command: KBARTICLE SP xml CRLF
   * Response: OK CRLF
   *
   */
  public static final String KBARTICLE_INSERT_COMMAND = "KBARTICLE";
  public static final String NOTIFY_KBARTICLE_INSERT_COMMAND = "NOTIFYKBARTICLE";

  /**
   * Command: DELETEKB SP id CRLF
   * Response: OK CRLF
   *
   */
  public static final String KBARTICLE_DELETE_COMMAND = "DELETEKB";
  public static final String NOTIFY_KBARTICLE_DELETE_COMMAND = "NOTIFYDELETEKB";
