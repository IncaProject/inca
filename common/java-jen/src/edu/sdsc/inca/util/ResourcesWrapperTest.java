...
public class ResourcesWrapperTest extends TestCase {
  ...
  public void testConstructorAndSave() throws Exception {
    ...
    assertEquals(
      "reloaded resources",
      encryptedResources.getResourceConfigDocument().xmlText(xmlOptions),
      encryptedResources2.getResourceConfigDocument().xmlText(xmlOptions)
    );
    encryptedFile.delete();
  }
  ...
  public void testEnvironVars( ) throws Exception {
    ...
    String series =
      ...
      "</xml-fragment>";
    Vector results = resources.expand( series, "cu12.ncsa.uiuc.edu", null );
  ...
  public void testExpand() throws Exception {
    ...
    for( int i = 0; i < shouldBe.length; i++ ) {
       assertEquals( "expansion", shouldBe[i], (String)argValues.get(i) );
    } 
