...
abstract public class XmlWrapper {
  ...
  public static boolean configEqual
    ...
    XmlOptions xmlOptions = getPrettyPrintOptions();
    String config1Text = config1copy.xmlText( xmlOptions );
    String config2Text = config2copy.xmlText( xmlOptions );
  ...
  public static String read( String filePath, String passphrase )
    throws FileNotFoundException, IOException, CrypterException {
  ...
  public static void save( String xmlText, String filePath, String passphrase )
    ...
    String encryptedXml = cryptSensitive(xmlText, passphrase, false);
   ...
   *
   * @return  An XmlOPtions object with pretty printing set.
   */
  public static XmlOptions getPrettyPrintOptions() {
