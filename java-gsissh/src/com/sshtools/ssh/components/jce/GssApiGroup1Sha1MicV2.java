 ...
 *
 */
public class GssApiGroup1Sha1MicV2 extends GssApiConstGroup {
	...
	static {
		ALGORITHM_NAME = "gss-group1-sha1-" + GSS_MECH_GLOBUS_GSSAPI_OPENSSL_MICV2_HASH;
	}
